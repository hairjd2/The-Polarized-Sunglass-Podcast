...
function playit(imageid='playbutton', audioid="audioPlayer") {
    if(document.getElementById(audioid).paused) {
      document.getElementById(audioid).play();
      document.getElementById(imageid).src = "static/src/pause.png";
    }else {
      document.getElementById(audioid).pause();
      document.getElementById(imageid).src = "static/src/play.png";
    }
}
...
function loadStats(data) {
  ...
  document.getElementById("Episode3plays").innerHTML = data.episodes.three.plays;
  document.getElementById("Episode4plays").innerHTML = data.episodes.four.plays;
